...
terminal    = "footclient"
menu        = "wofi  --width 300 --height 540 --yoffset -30  --xoffset 810 --allow-images --hide-scroll --prompt '' --insensitive --show drun"
lock        = "hyprlock"
...
hl.on("hyprland.start", function () 
    ...
    hl.exec_cmd("waybar")
    hl.exec_cmd("mako --ignore-timeout 1")
...
require("binds.window-management")
require("binds.misc")
--------------------------------
